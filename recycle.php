  ...
  <div class="row">
    <div class="span3">
      <div class="widget">
        ...
        <div class="footerlogo">
          <h6><a href="index.html">:: Receipt ::</a></h6>
          <!-- <img src="assets/img/logo.png" alt="" /> -->
        </div>
        <!-- end logo -->
        <address>
    <strong>Special Topics Class</strong><br>
     Computer Engineering, NU<br>
     Pitsanulok, TH 65000<br>
    <abbr title="Phone">P:</abbr> (+66) 88-3014335 </address>
      </div>
    </div>
    <div class="span3">
      <div class="widget">
    ...
    <div class="span3">
      <div class="widget">
        <h5>Keep updated</h5>
        <p>
          ป้อนอีเมลของคุณเพื่อสมัครรับจดหมายข่าว
        </p>
        <form>
          <div class="input-append">
            <input class="span2" id="appendedInputButton" type="text">
            <button class="btn btn-color" type="submit">ติดตาม</button>
          </div>
        </form>
