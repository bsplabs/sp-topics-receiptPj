...
<head>
  <meta charset="utf-8">
  <title>Bill สร้างใบเสร็จออนไลน์</title>
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="span4">
              <!-- logo -->
              <div class="logo">
                <h1><a href="index.html">:: receipt ::</a></h1>
                ...
                <div class="navbar-inner">
                  <nav>
                    <ul class="nav topnav">
                      ...
                      <li class="dropdown">
                        <a href="#">จัดการเอกสาร</a>
                        <ul class="dropdown-menu">
                          <li><a href="scaffolding.html">ใบสำคัญรับเงิน</a></li>
                          <li><a href="base-css.html">หนังสือรับเงิน</a></li>
                          <li><a href="components.html">บันทึกข้อความ</a></li>
                      ...
                      <li>
                        <a href="contact.html">เข้าสู่ระบบ</a>
                      </li>
                    </ul>
                  </nav>
                </div>
